...
After downloading the project or the folder, you must run the [password_checker.bat](https://github.com/NoahPrm/PasswordChecker/blob/main/Windows/password_checker.bat) file.
After launching the file, everything will be good!
